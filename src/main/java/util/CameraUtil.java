...
public class CameraUtil {
    ...
    public static void calculateCameraPosition(Camera camera, List<RenderObject> renderObjects) {
        ...
        checkCameraCollision(camera, tempPosition, renderObjects);
    }
    ...
    private static void checkCameraCollision(Camera camera, Vector3f tempPosition, List<RenderObject> renderObjects) {
