...
//        TexturedModel dormModel = EntityLoader.getTexturedModel("dorm");
...
//        EntityLoader.setParentObject(dorm);
...
//        TexturedModel openChestModel = EntityLoader.getTexturedModel("openchest");
//        TexturedModel closedChestModel = EntityLoader.getTexturedModel("closedchest");
...
//        TexturedModel nightstandModel = EntityLoader.getTexturedModel("nightstand");
//        for (int i = 0; i < 5; i++) {
...
//        TexturedModel bedModel = EntityLoader.getTexturedModel("bed");
...
//        EntityLoader.setParentObject(bed);
//        return bed;
//    }
//
//
...
//        TexturedModel doorModel = EntityLoader.getTexturedModel("door");
...
//        TexturedModel lanternModel = EntityLoader.getTexturedModel("lantern");
